                ...
                <div class="modal-body">
                    ...
                    @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="instituicao" name="instituicao" value="" required maxlength="191">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Nome do Professor:</label>
                            <input type="text" class="form-control" id="professor" name="professor" value="{{Auth::user()->name}}" required maxlength="191">
                        </div>
                ...
                <div class="modal-body">
                    <form name="cad_questao" action="{{url('questao')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" id="enunciado" rows="2" name="texto" maxlength="191" required></textarea>
                        </div>
